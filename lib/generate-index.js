...
<head>
    ...
    <style>
        ...
        * {
        ...
        .player-toggle-btn-collapsed:hover {
            background: rgba(255, 255, 255, 0.05);
            color: var(--text-primary);
        }
...
<body>
    ...
    <div class="player-container expanded" id="player-container">
        ...
        <div class="player-collapsed-view">
            ...
            <button class="player-toggle-btn-collapsed" id="player-toggle-btn-collapsed">
    ...
    <script>
        ...
        const playerToggleBtnCollapsed = document.getElementById('player-toggle-btn-collapsed');
        ...
        function initEventListeners() {
            ...
            playerToggleBtnCollapsed.addEventListener('click', expandPlayer);
        ...
        function updateCovers(album) {
            ...
            if (album.cover) {
                ...
                playerCollapsedCover.innerHTML = \`<img src="\${album.cover}" alt="\${album.name}">\`;
            } else {
                playerCover.innerHTML = '<i class="fas fa-music"></i>';
                playerModalCover.innerHTML = '<i class="fas fa-music"></i>';
                playerCollapsedCover.innerHTML = '<i class="fas fa-music"></i>';
            }
        }
